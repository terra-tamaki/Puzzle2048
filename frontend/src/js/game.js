...
class GameEngine {
    ...
    createBlocks() {
        ...
        const offsetY = 50 + (this.settings.paddleBlockDistance || 100);
    ...
    handleMouseMove(event) {
        ...
        this.paddle.setTargetX(mouseX, this.width);
    }
        ...
        switch (event.code) {
            ...
            case 'ArrowLeft':
                if (this.gameState.isGameStarted && !this.gameState.isPaused) {
                    this.paddle.setTargetX(this.paddle.x - 30, this.width);
                }
                break;
            case 'ArrowRight':
                if (this.gameState.isGameStarted && !this.gameState.isPaused) {
                    this.paddle.setTargetX(this.paddle.x + this.paddle.width + 30, this.width);
                }
                break;
        }
    }
